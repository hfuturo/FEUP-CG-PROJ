	...
	initBuffers() {
        ...
        for(var i = 0; i < this.slices; i++){
			...
			for (var j = 0; j < this.stacks; j ++){
				...
				this.indices.push(4*(i*this.stacks+j), (4*(i*this.stacks+j)+1), (4*(i*this.stacks+j)+2));
				//0, 2, 1
				this.indices.push(4*(i*this.stacks+j)+3, (4*(i*this.stacks+j)+2), (4*(i*this.stacks+j)+1));
				//3, 4, 2
			}
            ang+=alphaAng;
        }
